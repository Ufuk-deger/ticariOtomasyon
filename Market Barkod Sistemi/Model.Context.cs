...
namespace Market_Barkod_Sistemi
{
    ...
    public partial class marketBarkodSistemiDatabaseEntities2 : DbContext
    {
        public marketBarkodSistemiDatabaseEntities2()
            : base("name=marketBarkodSistemiDatabaseEntities2")
        {
        }
